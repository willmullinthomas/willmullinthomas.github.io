...
const Portfolio = () => {
    return (
        <div className="tab-container portfolio-body">
            ...
            >
                <div>
                    A portfolio website I created with the help of <a href="https://create-react-app.dev/" target="_blank" rel="noreferrer">Create React App</a> for the initial build configuration. Custom components and styling were created by me with the help of icon from <a href="https://fontawesome.com/" target="_blank" rel="noreferrer">Font Awesome</a>. The website is hosted right from the repo with <a href="https://pages.github.com/" target="_blank" rel="noreferrer">GitHub pages</a>.
                </div>
            </Card>
        </div>
    );
